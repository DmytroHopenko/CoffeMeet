...
timeLine
  ...
  .from(".direct_line > p", { opacity: 0, duration: 0.3 })
  .from(".navigation", { y: 90, opacity: 0 })
  .from(".navigation nav ul li a", { opacity: 0, stagger: 0.3 })
  .from(".navigation .logo_wrap img", { opacity: 0 })
  .from(".navigation .icons_wrap a", { opacity: 0, stagger: 0.3 });

timeLine2
  .from(".hero_wrap", { opacity: 0 })
  .from(".hero_information h1", { x: "-100%", opacity: 0, duration: 0.8 })
  .from(".hero_information p", { x: "-100%", opacity: 0, duration: 0.8 })
  .from(".hero_information .button_wrap a", {
    y: "100%",
    opacity: 0,
    stagger: 0.5,
    duration: 0.8,
